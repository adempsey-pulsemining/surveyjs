...
class MatrixRow extends Base {
  ...
  constructor(question, item) {
    ...
    this.value = null;
    this.name = typeof item === "object" ? (item.name || item.value) : item;
    this.title = typeof item === "object" ? (item.title || item.text || item.name) : item;
    this.changedBy = "";
    this.changedOn = "";
  }
...
class MatrixColumn extends Base {
  ...
  constructor(item) {
    ...
    this.name = typeof item === "object" ? (item.name || item.value) : item;
    this.title = typeof item === "object" ? (item.title || item.text || item.value) : item;
  }
}
