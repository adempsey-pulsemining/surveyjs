<template>
  <div class="sv_main" v-if="!showResults">
  ...
  <survey-results v-else-if="showResults" :survey="survey"></survey-results>
</template>
...
<script>
  ...
  import SurveyResults from "./survey-results.vue";
  ...
  export default {
    ...
    computed: {
      ...
      showResults() {
        return this.survey.completed && this.survey.showResultsPage
      }
    }
  }
</script>
