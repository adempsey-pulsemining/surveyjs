<template>
  <div class="sv_page" :class="{ 'page_break_before': pageBreak }">
    ...
    <div class="sv_page_spinner" v-if="survey.loadingPage">
      <b-spinner variant="primary"></b-spinner>
    </div>
    <div class="sv_page_body" v-else-if="hasElements">
...
<script>
  ...
  import { BSpinner } from "bootstrap-vue/src/components/spinner";
